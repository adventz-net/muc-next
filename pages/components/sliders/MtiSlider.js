                ...
                <div className="acc-pgm-overview mb-5">
                  ...
                  <div className="acc-pgm-body">
                    <p>
                      ...
                      enhance and promote career growth through training
                      workshops and programmes. It offers customised courses in
                      the areas of Finance, Information Technology, Marketing,
                      English Language, Leadership, Accounting… etc.
                    </p>
                    <p>
                      When the institute was first opened it was called "Centre
                      for Continuing Education", it ran a number of courses to a
                      high level for many years. In 2013 the centre became an
                      approved centre by the Ministry and Manpower and at this
                      point it changed its name to "Majan Training Unit". In
                      2022 the unit was approved to function as an institute by
                      the Ministry of Labour and the Ministry of Higher
                      Education, Research and Innovation.
                    </p>
                    <p>
                      As an extended arm to the college, Majan Training
                      Institute offers bespoke professional courses in the areas
                      of English Language, Information Technology, Finance,
                      Marketing, Business Management, Accounting and Leadership
                      Training.
                    </p>
                    <p>
                      Professional Development courses and Post-graduate
                      preparation courses delivered by tenured professors and
                      lecturers. Courses are audited each year by the Ministry
                      of Education and Ministry of Labour to ensure relevance
                      and to respond to the requirements of the national
                      economy.
                    </p>
                    <p>
                      With the priorities of Vision 2040 set by the Omani
                      government, Majan University College is uniquely
                      positioned to meet the demands of the future locally and
                      internationally.
                    </p>
                  </div>
                </div>
