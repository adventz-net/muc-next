                ...
                <div className="co-tb-overview">
                  <div className="co-tab-hd">
                    ...
                    <p className="pb-xl-4">
                      ...
                      proficiencies of web page design, networks administration,
                      databases, systems analysts, and technical support. Hence,
                      this programme provides a synthesis of business and
                      information technology to evaluate instantaneously
                      disseminated information via online resources, intranets,
                      and various networks of information for the purposes of
                  ...
                  <div className="table-responsive">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>English for Employability Skills</td>
                          <td>15</td>
                        </tr>
                        <tr>
                          <td>2</td>
                        ...
                        <tr>
                          <td>4</td>
                          <td>
                            Customer Experience Management / Brand
                            Communications
                          </td>
                          <td>15</td>
                        </tr>
                        ...
                        <tr>
                          <td>6</td>
                          <td>Digital Automation and Solutions</td>
                          <td>15</td>
                        </tr>
                        <tr>
                          <td>7</td>
                        ...
                        <tr>
                          <td>8</td>
                          <td>Internet Technology and Web Applications</td>
                          <td>15</td>
                        </tr>
                        <tr>
                          <td></td>
                  ...
                  <div className="table-responsive">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>Project (E-Business) (Dissertation)</td>
                          <td>30</td>
                        </tr>
                        <tr>
                          <td>2</td>
                          <td>Virtual Enterprises</td>
                          <td>15</td>
                        </tr>
                        <tr>
                          <td>3</td>
                        ...
                        <tr>
                          <td>6</td>
                          <td>Project Management Methods and Tools</td>
                          <td>15</td>
                        </tr>
                        <tr>
                          <td>7</td>
              ...
              <Tab.Pane eventKey="course-tab-04">
                ...
                <div className="co-tb-opertunity">
                  ...
                  <div className="co-tb-oper-body">
                    <p>
                      Graduate of e business can work as web-page designers,
                      systems analysts, technical support, and administrators
                      for networks and databases.
                    </p>
                    <p>
                      {' '}
