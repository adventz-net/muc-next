...
export default function UGModalOne() {
  return (
    <section className="ug-modal-cover-sec">
      ...
      <section className="ug-pgm-head-sec">
        <div className="ug-pgm-bg-graphics">
      ...
      <section className="ug-pgm-admin-sec">
        <div className="pgm-admin-bg-graphics">
        ...
        <Container fluid>
            ...
            <Col xl={12}>
              ...
              <div className="text-white">
                <p>
                  ...
                  sudents with an opportunity to gain indepth knowledge in their
          ...
          <Row>
            <Col xl={12}>
              <Accordion className="ug-pgm-accordian" defaultActiveKey="02">
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <p>
                      ...
                      marketing decisions. It will enhance students' ability to
                      apply the theoretical knowledge to analysis and evaluation
                      of marketing problems using appropriate market research
                      techniques. The subjects covered include marketing
                      strategy and campaign planning, public relations, event
                      management and journalism, working across different media
                      and technologies while skills such as analytical problem
          ...
          <Row>
            <Col xl={12}>
              <Accordion className="ug-pgm-accordian" defaultActiveKey="03">
                <Accordion.Item eventKey="0">
                  <Accordion.Header>Programme overview</Accordion.Header>
                  <Accordion.Body>
                    <p>
      ...
      <section className="ug-pgm-form-sec">
        <Container>
          <Row>
            <Col xl={12}>
