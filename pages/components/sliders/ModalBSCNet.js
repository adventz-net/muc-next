                ...
                <div className="co-tb-overview">
                  <div className="co-tab-hd">
                    ...
                    <p className="pb-xl-4">
                      ...
                      necessary knowledge and technical skills needed to design,
                      create, operate and maintain network infrastructure for
                      modern distributed enterprise computer systems. It will
                      also strengthen their awareness of networking security
                      threats and they will be able to implement networking
                    ...
                    <p>
                      ...
                      may be offered in any of the semesters in an academic
                      year.
                    </p>
                  </div>
                </div>
